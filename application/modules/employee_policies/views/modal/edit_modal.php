          ...
          <div class="row mt-3">
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control dta_edit_mv_file" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">MODEL NO.</label>
                    <input type="text" required  class="form-control dta_edit_model_no" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">DATE ISSUED</label>
                    <input type="text" required  class="form-control dta_edit_date_issued">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">PLATE NO.</label>
                    <input type="text" required class="form-control dta_edit_plate_no">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">MAKE</label>
                    <input type="text"  class="form-control dta_edit_date_from" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">FROM 12:00 NN</label>
                    <input type="text" required class="form-control dta_edit_date_from">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">MOTOR NO.</label>
                    <input type="text" required class="form-control dta_edit_motor_no" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">TYPE OF BODY</label>
                    <input type="text" required class="form-control dta_edit_type_body" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">TO 12:00 NN</label>
                    <input type="text" required class="form-control dta_edit_date_to" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">SERIAL / CHASSIS</label>
                    <input type="text"  class="form-control dta_edit_serial_chassis" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">OFFICIAL RECEIPT</label>
                    <input type="text" required class="form-control dta_edit_of_receipt" >
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control dta_edit_policy_no" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">COLOR</label>
                    <input type="text" class="form-control dta_edit_color" >
                </div>
              </div>
              <div class="col-md-4"></div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="text" required class="form-control dta_edit_place" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">OTHERS</label>
                  <input type="text" required class="form-control dta_edit_others">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">DATE</label>
                  <input type="text" required class="form-control dta_edit_date_day" >
              </div>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="text" required class="form-control dta_edit_docs_stamp" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">MONTH</label>
                  <input type="text" required class="form-control dta_edit_month" >
              </div>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="text" required class="form-control dta_edit_lgt" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">YEAR</label>
                  <input type="text" required class="form-control dta_edit_year" >
              </div>
            </div>
          </div>
          <hr>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="text" required class="form-control dta_edit_received_from" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">PREMIUM SALES</label>
                  <input type="text" required class="form-control dta_edit_premium_sales">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">MISC</label>
                  <input type="text" required class="form-control dta_edit_or_misc" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">ADDRESS</label>
                  <input type="text" required class="form-control dta_edit_or_address" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">DOCS. STAMP</label>
                  <input type="text" required class="form-control dta_edit_or_doc_stamp">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">TOTAL</label>
                  <input type="text" required class="form-control dta_edit_or_total" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">DATE</label>
                  <input type="text" required class="form-control dta_edit_or_date" >
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">LG TAX</label>
                  <input type="text" required class="form-control dta_edit_lg_tax">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                  <label for="recipient-name" class="col-form-label">THE SUM OF PESOS</label>
                  <input type="text" required class="form-control dta_edit_sum_pesos" >
              </div>
            </div>
        </div>
      </div>
