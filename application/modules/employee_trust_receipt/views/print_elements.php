<div id="print_trust_receipt" style="font-size:14px;display:block;">
    ...
    <div style="display:flex;justify-content:space-between;margin-top:40px;">
        <div>
            ...
            <div style='text-transform:uppercase;margin-top:20px;'>Mr. Juan Dela Cruz</div>
            <div>c/o LTO-MVIS</div>
            <div>Subang Dako Cebu City</div>

            <div style="margin-top:20px;">Dear Mrs. Dela Cruz</div>
        </div>
        <div>
            <div>Trust Receipt Form No: 0178</div>
            <div>Date Issued: December 1, 2021</div>
            <div>Place Issued: Cebu City</div>
        </div>
    </div>
    ...
    <div style='margin:40px 0;'>
        <div style="margin-top:30px"> Hoping to receive everything in order as stated above. </div>
        <div style="margin-top:30px">Thank you and GOD BLESS</div>
        <div style="margin-top:30px">Prepared By:</div>
        <div style="margin-top:30px">Annabelle B. Torino</div>
        <div style="margin-top:30px">Approved By:</div>
        <div style="margin-top:30px">Felix R. Secuya</div>
    </div>
