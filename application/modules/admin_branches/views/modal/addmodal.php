...
<div class="modal fade" id="add_branch_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
       <form id="frm_add_branch" method="post" action ="">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-map"></i> Add Branch</h5>
        ...
        <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select name="location" id="" class="form-control dta_add_location">
							<option value="">Please select...</option>
						</select>
                    </div>
                    <div class="col-md-6">
                        <label for="recipient-name" class="col-form-label">Branch Name</label>
                        <input required required name="branch_name"  type="text" class="form-control dta_add_branch_name" >
                    </div>
                </div>
        </div>
