...
<div id="print_OR" style="font-size:13px">
    <div class="print_cont" style="width:480px;">
        ...
        <div style="text-align:left;font-size:13px;position:relative">
            ...
            <div style="margin-top:20px;margin-left:60px;"><span style="width:66px;display:inline-block;" id="trans_date_to_month">November
            </span> <span id="trans_date_to_day"></span>  <span id="trans_date_to_year" style="margin-left:55px">21</span></div>
          
        </div>
       
        <div style="text-align:right;">
            <div style="text-align:left;margin-top:10px;font-size:13px;width:190px;display:inline-block;">
        ...
        <div class="text-align:left;font-size:12px;" id="trans_paid_type">
       ...
       <div class="ppop_name" style="line-height:20px;margin-left:-20px;margin-top:17px;position:relative;top:10px;">------<span class="ppop_address" style="display:block;">----</span></div>
        ...
        <div style="position:relative;top:710px;">  
            <div style="margin-left:-10px;">
                <span style="width:340px;display:inline-block;position:relative;left:60px;" class="ppop_place">Cebu City</span>
                <span style="display:inline-block;">
                    <span class="ppop_pop_day" style="display:inline-block;width:133px;position:relative;left:15px;">12</span>
                    <span class="ppop_pop_month" style="display:inline-block;width:132px;position:relative;left:10px;">November </span>
...
<div id="print_Policy_elem_motor" style="font-size:14px;text-transform:uppercase;display:none">
    <div style="width:720px;height:800px">
       ...
       <div  style="line-height:20px;margin-left:-20px;margin-top:17px;position:relative;top:10px;"><span class="ppop_name">Juan dela Cruz</span><span class="ppop_address" style="display:block;">Cebu City</span></div>
        <div style="text-align:right">
            <div style="width:363px;display:inline-block;text-align:left;">
                <div  style="position:relative;top: -18px;" ><span class="ppop_dateissued" style="width:185px;display:inline-block;">November 1, 2020</span><span class="ppop_or" style="display:inline-block">2345667</span></div>

                <div style="margin-top:5px;position:relative;top:8px;" ><span class="ppop_dfrom" style="width:175px;display:inline-block;">November 1, 2020</span><span class="ppop_dto" style="display:inline-block">November 1, 2021</span></div>   
            </div>
        </div>
        <div style="text-align:left;margin-left:-20px;position:relative;top:53px;">
