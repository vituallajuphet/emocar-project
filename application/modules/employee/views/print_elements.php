...
<div id="print_Policy_elem" style="font-size:14px;text-transform:uppercase;display:none">
    <div style="width:720px;height:800px">
        <div style="text-align:right;">
            <div style="width:190px;text-align:left;display:inline-block;margin-top:108px;" id="ppolicy_policy">123456</div>  
        </div>
       <div id="ppolicy_name" style="line-height:20px;margin-left:-20px;margin-top:17px;position:relative;top:10px;">Juan dela Cruz<span id="ppolicy_address" style="display:block;">Cebu City</span></div>
        <div style="text-align:right">
            <div style="width:363px;display:inline-block;text-align:left;">
                <div id="ppolicy_date_issued" style="position:relative;top: -18px;" ><span style="width:185px;display:inline-block;">November 1, 2020</span><span id="ppolicy_or" style="display:inline-block">2345667</span></div>
        ...
        <div style="text-align:left;margin-left:-20px;position:relative;top:53px;">
            <div style="display:inline-block;width:144px;" id="ppolicy_model">2014</div>
            <div style="display:inline-block;width:139px;" id="ppolicy_make">HYUNDAI</div> 
        ...
        <div style="text-align:left;margin-left:-20px;position:relative;top:66px;">
            <div style="display:inline-block;width:130px;" id="ppolicy_plate_no">AAE6626</div>
            <div style="display:inline-block;width:155px;" id="ppolicy_serial">A2F1GASH21UY51H51</div>
            <div style="display:inline-block;width:141px;" id="ppolicy_motor_no">6123HSLGS123</div>
        </div>

        <div style="text-align:right;font-size:16px;">
              <div style="width:230px;text-align:left;display:inline-block;position:relative;top:102px;" id="ppolicy_premium_paid">560.00</div>  
        </div>

        <div style="text-align:right;position:relative;top:300px;">
            <div style="width:100px;display:inline-block;text-align:left;">
                <div id="ppolicy_prem">560.00</div>
                <div id="ppolicy_doc_stamp">200.00</div>
                <div id="ppolicy_vat_tax">290.00</div>
                <div id="ppolicy_lg_tax">200.00</div>
                <div id="ppolicy_total_amount_due" style="position:relative;top:3px;">1,250.00</div>
            </div>
        </div>

        <div style="position:relative;top:710px;">  
            <div style="margin-left:-10px;">
                <span style="width:340px;display:inline-block;position:relative;left:60px;">Cebu City</span>
                <span style="display:inline-block;">
                    <span style="display:inline-block;width:133px;position:relative;left:15px;">12</span>
                    <span style="display:inline-block;width:132px;position:relative;left:10px;">November </span>
                    <span style="display:inline-block;position:relative;left:20px;">20</span>
                </span>
            </div>
        </div>
    </div>
...
<div id="print_Policy_elem_motor" style="font-size:14px;text-transform:uppercase;display:none">
    <div style="width:720px;height:800px">
        <div style="text-align:right;">
            <div style="width:190px;text-align:left;display:inline-block;margin-top:120px;" id="ppolicy_policy2">123456</div>  
        </div>
       <div id="ppolicy_name" style="line-height:20px;margin-left:-20px;margin-top:17px;position:relative;top:10px;">Juan dela Cruz<span id="ppolicy_address" style="display:block;">Cebu City</span></div>
        <div style="text-align:right">
            <div style="width:363px;display:inline-block;text-align:left;">
