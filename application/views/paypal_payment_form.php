        ...
        paypal.Button.render({
            ...
            payment: function(data, actions) {
              // rteturn actions;
                ...
                var CREATE_URL = "<?= base_url("register/ajax_payment?paypal=direct") ?>";
            ...
            onAuthorize: function(data, actions) {
                ...
                var EXECUTE_URL = "<?= base_url("register/ajax_payment?paypal=return") ?>";
