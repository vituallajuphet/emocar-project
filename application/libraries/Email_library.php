...
class email_library {
        ...
        protected $CI;
        protected $from_email  = "noreply@system.com";
        protected $to_email ="noreply@system.com";
        protected $smtp_host ="secure.emailsrvr.com";
        protected $protocol ="smtp";
        // protected $smtp_user = "form_online050@proweaver.net";
        // protected $smtp_pass = "pqR0_skC1itYsl#20";
         protected $smtp_user = "form_online020@proweaver.net";
         protected $smtp_pass = "r_KUwne2c@S_forMW@";
        
        protected $smtp_port =587;
        protected $message ="sample message";
        protected $mail_type ="html";
        protected $subject ="Compassionate Academy";
        protected $error ="";
        protected $attach ="";
        ...
        public function sendmail($data= array()){
                ...
                if (empty($data['from_email'])) {
                  $this->CI->email->from("noreply@system.com");
                }else{
