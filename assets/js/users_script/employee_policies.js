        ...
        "columns": [
            ...
            { "data": "date_issued" },
            {
                "data": "trans_id", "render": function (data, type, row, meta) {
                    var btns = `
                        <div class="action_btns"><a class="btn_view" data-id="${row.trans_id}" href="#">View</a>  <a data-id="${row.trans_id}" class="btn_edit" href="#">Edit</a> <a class="btn_delete" data-id="${row.trans_id}" href="#">Delete</a></div>
                    `
                    return btns;
                }
            },
